...
const ChartCards = ({
  ...
  return (
    <div className="bg-white shadow-md shadow-gray-400 rounded-sm flex flex-col w-[330px] h-[300px] p-5">
      <div className="flex flex-row w-full h-[280px] gap-3 items-center justify-center">
